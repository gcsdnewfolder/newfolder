...
::File Name Check
::ren "%~dp0%~nx0" "Menu - %version%.bat"
::IF %~nx0=="Menu - %version%.bat" (
  ::If the current file name is correct
::  echo Your batch file's name is valid.
::  )

::IF NOT %~nx0=="Menu - %version%.bat" (
  ::If the current installed version is older than the latest version
::  echo Your batch file's name is invalid.
::  )
